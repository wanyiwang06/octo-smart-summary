...
func setupMembersTestDB(t *testing.T) *gorm.DB {
	...
	db.AutoMigrate(&model.SummaryTask{}, &model.SummarySource{}, &model.SummaryParticipant{}, &model.PersonalResult{}, &model.PersonalResultVersion{}, &model.SummarySchedule{}, &model.SummaryResult{})
