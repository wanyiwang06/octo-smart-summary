...
| `DOCUMENT_SUMMARY_SOURCE_API_URL` | Document-source service base URL for the AI 速览 preview (`POST /api/v1/summaries/document/preview`). When both this and its fallback are unset, the endpoint answers HTTP 502 / code `50201` | Yes (for document preview) | — |
